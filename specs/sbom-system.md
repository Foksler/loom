...
This specification describes how Loom generates and distributes Software Bills of Materials (SBOMs) to provide transparency about dependencies used in both the CLI and server components.
