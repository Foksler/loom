...
impl AuthError {
    ...
    pub fn is_internal(&self) -> bool {
        matches!(self, AuthError::Database(_) | AuthError::HashingError(_) | AuthError::Internal(_) | AuthError::Configuration(_))
    }
    ...
    pub fn status_code(&self) -> u16 {
        match self {
            ...
            AuthError::Database(_) | AuthError::HashingError(_) | AuthError::Internal(_) | AuthError::Configuration(_) => 500,
        }
    }
}
