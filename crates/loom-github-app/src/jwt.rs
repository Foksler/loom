...
///
/// The JWT is signed with the app's private RSA key and is valid for up to 10 minutes.
/// We use a 9-minute expiry to provide some buffer before the GitHub maximum.
///
/// # Arguments
///
...
///
/// Returns the duration until the token should be refreshed (30 seconds before expiry).
