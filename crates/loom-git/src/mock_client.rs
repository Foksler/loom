...
mod tests {
    ...
    ///
    /// Why this test is important: The mock is used to verify that code under test
    /// calls the git client methods in the expected order and with expected arguments.
    /// Incorrect recording would lead to false positive tests.
    #[tokio::test]
    ...
    ///
    /// Why this test is important: Tests need to verify behavior based on different
    /// diff contents. The mock must correctly return the configured diff for
    /// assertions in tests.
    #[tokio::test]
    ...
    /// clearing the history between phases. This verifies the clear functionality.
    #[tokio::test]
