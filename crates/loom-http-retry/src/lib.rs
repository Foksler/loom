...
mod tests {
    ...
    /// the retry function immediately returns the error without additional attempts.
    /// This is important because retrying non-retryable errors (e.g., 404 Not Found,
    /// 401 Unauthorized) wastes resources and delays error propagation to callers.
    #[tokio::test]
    ...
    /// simultaneously after a shared failure, overwhelming the recovering service.
    /// Without jitter, exponential backoff alone can still cause synchronized retries.
    #[test]
