...
//!
//! This module provides utilities for loading secrets from environment variables
//! with support for the `*_FILE` convention used by Docker secrets and Kubernetes.
...
///
/// This is a convenience wrapper around [`load_secret_env`] that returns an error
/// if neither `VAR` nor `VAR_FILE` is set.
///
/// # Example
///
/// ```no_run
...
mod tests {
    ...
    mod load_secret_env_tests {
        ...
        /// Verifies that load_secret_env returns None when neither VAR nor VAR_FILE is set.
        /// This is important for optional configuration values.
        #[test]
    ...
    mod require_secret_env_tests {
        ...
        /// Verifies that require_secret_env returns error when neither VAR nor VAR_FILE is set.
        #[test]
