...
impl GoogleOAuthConfig {
	...
	///
	/// - `LOOM_GOOGLE_CLIENT_ID`: The OAuth application's client ID.
	/// - `LOOM_GOOGLE_CLIENT_SECRET`: The OAuth application's client secret.
	/// - `LOOM_GOOGLE_REDIRECT_URI`: The callback URL for OAuth redirects.
	///
	/// # Returns
	///
	...
	pub fn from_env() -> Result<Self, ConfigError> {
		let client_id = env::var("LOOM_GOOGLE_CLIENT_ID")
			.map_err(|_| ConfigError::MissingEnvVar("LOOM_GOOGLE_CLIENT_ID".to_string()))?;

		let client_secret = env::var("LOOM_GOOGLE_CLIENT_SECRET")
			.map_err(|_| ConfigError::MissingEnvVar("LOOM_GOOGLE_CLIENT_SECRET".to_string()))?;

		let redirect_uri = env::var("LOOM_GOOGLE_REDIRECT_URI")
			.map_err(|_| ConfigError::MissingEnvVar("LOOM_GOOGLE_REDIRECT_URI".to_string()))?;
